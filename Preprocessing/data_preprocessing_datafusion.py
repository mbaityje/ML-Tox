...
DATA_PROPERTY_PATH = [
    'data/DSSToxQueryWPred1.xlsx', 'data/DSSToxQueryWPred2.xlsx',
    'data/DSSToxQueryWPred3.xlsx', 'data/DSSToxQueryWPred4.xlsx'
]

tests, species, results, properties = load_raw_data(DATA_TEST_PATH,
                                                    DATA_RESULTS_PATH,
                                                    DATA_SPECIES_PATH,
                                                    DATA_PROPERTY_PATH)
...
pubchem = pd.read_csv("data/cas_pubchem_tot.csv")
results_pub = results_imputated.merge(pubchem[["smiles", "pubchem2d"]],
                                      on="smiles")
