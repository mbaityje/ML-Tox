    ...
    df_property = df_property.rename(
        {
            ...
            "Structure_MolWt": "Mol",
            "NCCT_MP": "MeltingPoint",
            "NCCT_WS": "WaterSolubility",
        },
        axis=1,
    )
...
def impute_conc(results_prefiltered):
    ...
    db_filtered_mean.loc[db_filtered_mean.conc1_unit == "umol/L", "conc1_mean"] = (
        ...
        / (10 ** (3))
        * db_filtered_mean.Mol[db_filtered_mean.conc1_unit == "umol/L"]
    )
    ...
    db_filtered_mean.loc[db_filtered_mean.conc1_unit == "mmol/L", "conc1_mean"] = (
        ...
        * db_filtered_mean.Mol[db_filtered_mean.conc1_unit == "mmol/L"]
    )
    ...
    db_filtered_mean.loc[db_filtered_mean.conc1_unit == "nmol/L", "conc1_mean"] = (
        ...
        / (10 ** (6))
        * db_filtered_mean.Mol[db_filtered_mean.conc1_unit == "nmol/L"]
    )
    ...
    db_filtered_mean.loc[db_filtered_mean.conc1_unit == "mol/L", "conc1_mean"] = (
        ...
        * (10 ** (3))
        * db_filtered_mean.Mol[db_filtered_mean.conc1_unit == "mol/L"]
    )
...
def process_features(chemical_features):
    ...
    db[["WaterSolubility"]] = pt.transform(
        db.WaterSolubility.values.reshape(-1, 1)
    ).ravel()
